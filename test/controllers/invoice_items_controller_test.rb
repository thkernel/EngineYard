...
class InvoiceItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invoice_item" do
    assert_difference('InvoiceItem.count') do
      post invoice_items_url, params: { invoice_item: { amount: @invoice_item.amount, end_date: @invoice_item.end_date, engine_id: @invoice_item.engine_id, invoice_id: @invoice_item.invoice_id, start_date: @invoice_item.start_date, uid: @invoice_item.uid } }
    end
  ...
  test "should update invoice_item" do
    patch invoice_item_url(@invoice_item), params: { invoice_item: { amount: @invoice_item.amount, end_date: @invoice_item.end_date, engine_id: @invoice_item.engine_id, invoice_id: @invoice_item.invoice_id, start_date: @invoice_item.start_date, uid: @invoice_item.uid } }
